...
var UniversalRouter = _interopDefault(require('@luxamm/universal-router/artifacts/contracts/UniversalRouter.sol/UniversalRouter.json'));
...
var routerSdk = require('@luxamm/router-sdk');
require('jsbi');
...
var SwapRouter = /*#__PURE__*/function () {
  ...
  SwapRouter.getExecuteSignedPayload = function getExecuteSignedPayload(calldata, signedOptions, deadline, chainId, routerAddress) {
    ...
    var deadlineStr = ethers.BigNumber.from(deadline).toString();
    var value = {
      commands: commands,
      inputs: inputs,
      intent: intent,
...
Object.defineProperty(exports, 'URVersion', {
  enumerable: true,
  get: function () {
    return v4Sdk.URVersion;
  }
});
