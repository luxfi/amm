...
export class UnsignedHybridOrder {
    ...
    hash() {
        ...
        return hashHybridOrder(Object.assign(Object.assign({}, this.info), { cosignerData: {
    ...
    serialize() {
        ...
        const orderData = abiCoder.encode(HYBRID_ORDER_ABI, [
            [
                ...
                [BigNumber.from(0), [], ZERO_ADDRESS, BigNumber.from(0), BigNumber.from(0)],
...
export class CosignedHybridOrder extends UnsignedHybridOrder {
    ...
    static fromJSON(json, chainId, resolver, _permit2Address) {
        ...
        return new CosignedHybridOrder({
            ...
            cosignerData: {
                ...
                exclusivityOverrideBps: BigNumber.from((_b = json.cosignerData.exclusivityOverrideBps) !== null && _b !== void 0 ? _b : 0),
                exclusivityEndBlock: BigNumber.from((_c = json.cosignerData.exclusivityEndBlock) !== null && _c !== void 0 ? _c : 0),
            },
    ...
    resolve(options) {
        ...
        if (this.info.cosigner !== ZERO_ADDRESS) {
            ...
            if (ethers.utils.getAddress(recovered) !==
        ...
        const priorityFeeAboveBaseline = options.priorityFeeWei.gt(this.info.baselinePriorityFee)
            ...
            : BigNumber.from(0);
        const useExactIn = this.info.scalingFactor.gt(BASE_SCALING_FACTOR) ||
        ...
        const scalingMultiplier = currentScalingFactor.sub(BASE_SCALING_FACTOR.sub(this.info.scalingFactor).mul(priorityFeeAboveBaseline));
        return {
    ...
    for (let i = 0; i < parameters.length; i++) {
        ...
        if (blocksPassed < segmentEnd) {
            if (previousDuration === 0 && lastZeroDurationScaling) {
                ...
                return locateCurrentAmount(lastZeroDurationScaling, scalingFactor, blocksCounted, blocksPassed, segmentEnd, lastZeroDurationScaling.gt(BASE_SCALING_FACTOR));
            }
            ...
            return locateCurrentAmount(scalingFactor, endScalingFactor, blocksCounted, blocksPassed, segmentEnd, scalingFactor.gt(BASE_SCALING_FACTOR));
        }
