...
import { CosignedHybridOrder, CosignedPriorityOrder, CosignedV2DutchOrder, DutchOrder, RelayOrder, UnsignedHybridOrder, UnsignedPriorityOrder, UnsignedV2DutchOrder, } from "../order";
...
export class UniswapXOrderParser extends OrderParser {
    ...
    getOrderType(order) {
        ...
        if (order instanceof UnsignedHybridOrder ||
