...
export function multicallSameContractManyFunctions(provider, params, stateOverrrides, blockOverrides) {
...
export function multicallSameFunctionManyContracts(provider, params, stateOverrrides, blockOverrides) {
    return __awaiter(this, void 0, void 0, function* () {
...
export function multicall(provider, calls, stateOverrides, blockOverrides) {
    return __awaiter(this, void 0, void 0, function* () {
        const chainId = (yield provider.getNetwork()).chainId;
        const code = yield provider.getCode(multicallAddressOn(chainId));
        let response;
        if (code.length > 2) {
