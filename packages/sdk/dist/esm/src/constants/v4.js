 ...
 */
export const PERMIT2_DOMAIN_TYPE_HASH = ethers.utils.keccak256(ethers.utils.toUtf8Bytes("EIP712Domain(string name,uint256 chainId,address verifyingContract)"));
/**
 * EIP-712 Domain type hash for DCAHook
 */
export const DCA_HOOK_DOMAIN_TYPE_HASH = ethers.utils.keccak256(ethers.utils.toUtf8Bytes("EIP712Domain(string name,string version,uint256 chainId,address verifyingContract)"));
/**
 * Permit2 Witness Transfer From type hash
 */
export const PERMIT_WITNESS_TRANSFER_FROM_TYPE_HASH = ethers.utils.keccak256(ethers.utils.toUtf8Bytes("PermitWitnessTransferFrom(" +
 ...
 */
export const TOKEN_PERMISSIONS_TYPE_HASH = ethers.utils.keccak256(ethers.utils.toUtf8Bytes("TokenPermissions(address token,uint256 amount)"));
/**
