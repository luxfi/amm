...
export interface TokenTransferHookInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "permit2" | "preExecutionHook" | "reactor"): FunctionFragment;
    encodeFunctionData(functionFragment: "permit2", values?: undefined): string;
    encodeFunctionData(functionFragment: "preExecutionHook", values: [PromiseOrValue<string>, ResolvedOrderStruct]): string;
    encodeFunctionData(functionFragment: "reactor", values?: undefined): string;
    decodeFunctionResult(functionFragment: "permit2", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "preExecutionHook", data: BytesLike): Result;
...
export interface TokenTransferHook extends BaseContract {
    ...
    functions: {
        ...
        preExecutionHook(filler: PromiseOrValue<string>, resolvedOrder: ResolvedOrderStruct, overrides?: Overrides & {
    ...
    callStatic: {
        permit2(overrides?: CallOverrides): Promise<string>;
        preExecutionHook(filler: PromiseOrValue<string>, resolvedOrder: ResolvedOrderStruct, overrides?: CallOverrides): Promise<void>;
        reactor(overrides?: CallOverrides): Promise<string>;
    };
    filters: {};
    estimateGas: {
