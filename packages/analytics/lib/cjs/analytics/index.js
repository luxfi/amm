...
const ApplicationTransport_js_1 = require("./ApplicationTransport.js");
...
function initializeAnalytics(apiKey, originApplication, config) {
    ...
    /* options= */
    {
        ...
        transportProvider: new ApplicationTransport_js_1.ApplicationTransport(originApplication, config === null || config === void 0 ? void 0 : config.reportOriginCountry),
