...
exports.TraceEvent = (0, react_1.memo)((props) => {
    ...
    return ((0, jsx_runtime_1.jsx)(Trace_js_1.Trace, Object.assign({}, traceProps, { children: (0, jsx_runtime_1.jsx)(Trace_js_1.TraceContext.Consumer, { children: (traceContext) => react_1.Children.map(children, (child) => {
    ...
    for (const event of events) {
        eventHandlers[event] = (eventHandlerArgs) => {
            ...
            if (shouldLogImpression) {
                (0, index_js_1.sendAnalyticsEvent)(name, Object.assign(Object.assign(Object.assign({}, traceContext), properties), { action: event }));
            }
        };
    }
