...
var IApproveAndCall = _interopDefault(require('@luxamm/swap-router-contracts/artifacts/contracts/interfaces/IApproveAndCall.sol/IApproveAndCall.json'));
var v3Sdk = require('@luxamm/v3-sdk');
var IMulticallExtended = _interopDefault(require('@luxamm/swap-router-contracts/artifacts/contracts/interfaces/IMulticallExtended.sol/IMulticallExtended.json'));
var IPeripheryPaymentsWithFeeExtended = _interopDefault(require('@luxamm/swap-router-contracts/artifacts/contracts/interfaces/IPeripheryPaymentsWithFeeExtended.sol/IPeripheryPaymentsWithFeeExtended.json'));
var ISwapRouter02 = _interopDefault(require('@luxamm/swap-router-contracts/artifacts/contracts/interfaces/ISwapRouter02.sol/ISwapRouter02.json'));
var v2Sdk = require('@luxamm/v2-sdk');
var v4Sdk = require('@luxamm/v4-sdk');
