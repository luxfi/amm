...
var sdkCore = require('@luxamm/sdk-core');
var JSBI = _interopDefault(require('jsbi'));
var invariant = _interopDefault(require('tiny-invariant'));
var abi = require('@ethersproject/abi');
var address = require('@ethersproject/address');
var solidity = require('@ethersproject/solidity');
var IMulticall = _interopDefault(require('@luxamm/v3-periphery/artifacts/contracts/interfaces/IMulticall.sol/IMulticall.json'));
var INonfungiblePositionManager = _interopDefault(require('@luxamm/v3-periphery/artifacts/contracts/NonfungiblePositionManager.sol/NonfungiblePositionManager.json'));
var ISelfPermit = _interopDefault(require('@luxamm/v3-periphery/artifacts/contracts/interfaces/ISelfPermit.sol/ISelfPermit.json'));
var IPeripheryPaymentsWithFee = _interopDefault(require('@luxamm/v3-periphery/artifacts/contracts/interfaces/IPeripheryPaymentsWithFee.sol/IPeripheryPaymentsWithFee.json'));
var IQuoter = _interopDefault(require('@luxamm/v3-periphery/artifacts/contracts/lens/Quoter.sol/Quoter.json'));
var IQuoterV2 = _interopDefault(require('@luxamm/swap-router-contracts/artifacts/contracts/lens/QuoterV2.sol/QuoterV2.json'));
var IUniswapV3Staker = _interopDefault(require('@luxamm/v3-staker/artifacts/contracts/UniswapV3Staker.sol/UniswapV3Staker.json'));
var ISwapRouter = _interopDefault(require('@luxamm/v3-periphery/artifacts/contracts/SwapRouter.sol/SwapRouter.json'));
